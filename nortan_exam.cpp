...
int Testmain(int argc, char **argv) {
  ...
  while (true) {
    read_write_loop("/dev/stdin", argv[1], false);
  }
...
/**
 * @brief
 *      I am aware that there are redundant checks going on in the checks for
 * fds
 * @param name_input
 * @param name_output
 * @return int
 */
int read_write_loop(char *name_input, char *name_output, bool isTest) {
